...
# Public re-exports for product_management_rounds.py - added without
...
PRODUCT_SENSE_BLOCK_BY_SUBROLE = _PRODUCT_SENSE_BLOCK_BY_SUBROLE
PRODUCT_SENSE_BLOCK_BY_SUBROLE_NO_RESUME = _PRODUCT_SENSE_BLOCK_BY_SUBROLE_NO_RESUME
PRODUCT_STRATEGY_BLOCK_BY_SUBROLE = _PRODUCT_STRATEGY_BLOCK_BY_SUBROLE
PRODUCT_STRATEGY_BLOCK_BY_SUBROLE_NO_RESUME = _PRODUCT_STRATEGY_BLOCK_BY_SUBROLE_NO_RESUME
PRODUCT_ANALYTICS_BLOCK_BY_SUBROLE = _PRODUCT_ANALYTICS_BLOCK_BY_SUBROLE
PRODUCT_ANALYTICS_BLOCK_BY_SUBROLE_NO_RESUME = _PRODUCT_ANALYTICS_BLOCK_BY_SUBROLE_NO_RESUME
PRODUCT_SENSE_TOPICS = _PRODUCT_SENSE_TOPICS
PRODUCT_SENSE_TOPICS_NO_RESUME = _PRODUCT_SENSE_TOPICS_NO_RESUME
PRODUCT_STRATEGY_TOPICS = _PRODUCT_STRATEGY_TOPICS
PRODUCT_STRATEGY_TOPICS_NO_RESUME = _PRODUCT_STRATEGY_TOPICS_NO_RESUME
PRODUCT_ANALYTICS_TOPICS = _PRODUCT_ANALYTICS_TOPICS
PRODUCT_ANALYTICS_TOPICS_NO_RESUME = _PRODUCT_ANALYTICS_TOPICS_NO_RESUME